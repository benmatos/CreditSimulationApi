...
namespace CreditsimulacaoApi.Controllers
{
    ...
    public class simulacaoController : ControllerBase
    {
        ...
        {
            // Simulação de dados coletados das métricas Prometheus
            var dataReferencia = DateTime.UtcNow.ToString("yyyy-MM-dd");

            // Aqui você precisaria acessar os valores reais das métricas
            // Para fins de exemplo, vamos usar valores fictícios
            var qtdRequisicoes = 135;
            var tempoMedio = 150; // em milissegundos
            var tempoMinimo = 23;
            var tempoMaximo = 860;
            var percentualSucesso = 0.98;
